        ...
        for i in range(self.width):
            for j in range(self.height):
                if not self.is_empty(j, i):
                    ...
                    if form == 1:
                        canvas.create_oval(i*50 + 5, j*50 + 5, (i+1)*50 - 5, (j+1)*50-5, outline=color, fill="WHITE", width=2)
                    if form == 2:
                    ...
                    if form == 3:
                        canvas.create_rectangle(i*50 + 5, j*50 + 5, (i+1)*50 - 5, (j+1)*50-5, outline=color, fill="WHITE", width=2)
